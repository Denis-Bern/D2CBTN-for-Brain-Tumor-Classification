...
def func_cv(X_train, y_train, cv_itr, n_cv):
    ...
    output_dir = "10_FOLD_EfficientNetB0_Model"
    ...
    for train_ix, test_ix in cv_itr.split(X_train, y_train):
        ...
        plt.savefig(os.path.join(output_dir, f'Comfusion_matrix_10_FOLD_EfficientNetB0_Fold_{ix}.pdf'))
        plt.show()
        print('\n\n')
        ...
        # Save the plot as a PDF file
        plt.savefig(os.path.join(output_dir, f'Training_curve_10_FOLD_EfficientNetB0_Fold_{ix}.pdf'))
        plt.show()
        print('\n\n')
        ...
        # Save the plot as a PDF file
        plt.savefig(os.path.join(output_dir, f'Loss_curve_10_FOLD_EfficientNetB0_Fold_{ix}.pdf'))
        plt.show()
        print('\n\n')
        ...
        plt.legend(loc="lower right", fontsize = 14)
        # Save the plot as a PDF file
        plt.savefig(os.path.join(output_dir, f'Receiver Operating Characteristic_10_FOLD_EfficientNetB0_Fold_{ix}.pdf'))
        plt.show()
    ...
    plt.show()
    # Save the plot as a PDF file
    plt.savefig(os.path.join(output_dir, 'Aggregated_Comfusion_matrix_10_FOLD_EfficientNetB0.pdf'))
    #####################################################################################################
    ...
    # Save the plot as a PDF file
    plt.savefig(os.path.join(output_dir, f'Aggregated_Training_curve_10_FOLD_EfficientNetB0.pdf'))
    plt.show()
    ...
    # Save the plot as a PDF file
    plt.savefig(os.path.join(output_dir, f'Aggregated_Loss_curve_10_FOLD_EfficientNetB0.pdf'))
    plt.show()
    #####################################################################################################
    
    # SAVE MODEL
    model.save_weights("10_FOLD_EfficientNetB0.h5") 
...
#Saving AF_classification result
